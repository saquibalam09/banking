    ...
    <div>
      <Table>
        <TableHeader className="bg-[#f9fafb]">
          <TableRow>
            <TableHead className="p-2">Transaction</TableHead>
            <TableHead className="p-2">Amount</TableHead>
            <TableHead className="p-2">Status</TableHead>
            <TableHead className="p-2">Date</TableHead>
            <TableHead className="p-2 max-md:hidden">Channel</TableHead>
            <TableHead className="p-2 max-md:hidden">Category</TableHead>
          </TableRow>
        </TableHeader>
        <TableBody>
